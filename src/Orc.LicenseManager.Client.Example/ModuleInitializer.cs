...
public static class ModuleInitializer
{
    ...
    {
        var licenseService = ServiceLocator.Default.ResolveType<ILicenseService>(); // A Valid lisence for this application ID aka Public Key can be found in Doc/FakeLisenceInfo.txt
